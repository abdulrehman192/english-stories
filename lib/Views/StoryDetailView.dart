                              ...
                              SliverAppBar(
                                ...
                                flexibleSpace: FlexibleSpaceBar(
                                  ...
                                  title: (_scrollController.positions.isNotEmpty) && _scrollController.offset >= 144 ? Padding(
                                    ...
                                    child: Text('${controller.story.title}', style: TextStyle(fontWeight: FontWeight.bold, color: Colors.white), overflow: TextOverflow.ellipsis,),
                                  ) :
                                  ...
                                  Padding(
                                    ...
                                    child: Row(
                                      ...
                                      children: [
                                        ...
                                        Flexible(
                                            child: Text('${controller.story.title}',style: TextStyle(fontSize: _isCollapsed ? 16.sp : 15.sp, fontWeight: FontWeight.w700), )
                                        ),
